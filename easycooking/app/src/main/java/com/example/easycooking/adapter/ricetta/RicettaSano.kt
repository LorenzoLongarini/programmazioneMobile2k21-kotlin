...
class RicettaSano {
        ...
        constructor(nome: String?, image: String?, descrizione: String?, prepTime: String?, cookTime: String?, totalTime: String?, keywords: List<String>?, recipeCategory: String?, recipeCuisine: String?, intolleranze: List<String>?, vegano: Boolean, porzioni: Int,  preparazione: String?){
                this.nome=nome
                this.image=image
