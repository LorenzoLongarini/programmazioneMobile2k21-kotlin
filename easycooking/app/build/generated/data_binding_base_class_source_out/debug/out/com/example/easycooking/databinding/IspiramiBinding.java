...
public final class IspiramiBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton buttonShare1;
  ...
  private IspiramiBinding(@NonNull ScrollView rootView, @NonNull TextView Ingredienti,
      @NonNull TextView Quantit, @NonNull TextView UnitDimisura, @NonNull ImageButton buttonShare1,
      @NonNull TextView categoria, @NonNull TextView immagineRicettaVista,
      @NonNull TextView intolleranze, @NonNull TextView origine, @NonNull ImageView photo,
      @NonNull TextView procedimentoVista, @NonNull Button randomButton,
    ...
    this.buttonShare1 = buttonShare1;
  ...
  @NonNull
  public static IspiramiBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static IspiramiBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ispirami, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static IspiramiBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.button_share1;
      ImageButton buttonShare1 = rootView.findViewById(id);
      if (buttonShare1 == null) {
        break missingId;
      }
      ...
      Button randomButton = rootView.findViewById(id);
      ...
      return new IspiramiBinding((ScrollView) rootView, Ingredienti, Quantit, UnitDimisura,
          buttonShare1, categoria, immagineRicettaVista, intolleranze, origine, photo,
          procedimentoVista, randomButton, tableLayout, tableLayout2, tableLayout3, tableLayout4,
          tempoCottura, tempoPreparazione, tempoTotale, textView27, textView28, textView29,
          textView33, textView34, textView35, textView36, textView41, textView43, vegano);
    }
