...
public final class ActivityRicettaTuaBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityRicettaTuaBinding(@NonNull ScrollView rootView, @NonNull TextView Ingredienti,
      @NonNull TextView immagineRicettaVista, @NonNull TextView procedimentoVista,
      @NonNull TableLayout tableLayout, @NonNull TableLayout tableLayout4,
      ...
      @NonNull TextView textView29, @NonNull TextView textView41, @NonNull TextView textView43) {
  ...
  @NonNull
  public static ActivityRicettaTuaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRicettaTuaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_ricetta_tua, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRicettaTuaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRicettaTuaBinding((ScrollView) rootView, Ingredienti, immagineRicettaVista,
          procedimentoVista, tableLayout, tableLayout4, tempoCottura, tempoPreparazione,
          tempoTotale, textView27, textView28, textView29, textView41, textView43);
    }
