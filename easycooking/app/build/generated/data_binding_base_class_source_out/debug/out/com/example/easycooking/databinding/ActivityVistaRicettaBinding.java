...
public final class ActivityVistaRicettaBinding implements ViewBinding {
  ...
  private ActivityVistaRicettaBinding(@NonNull ScrollView rootView, @NonNull TextView Ingredienti,
      @NonNull TextView Quantit, @NonNull TextView UnitDimisura, @NonNull Button button2,
      @NonNull ImageButton buttonShare, @NonNull TextView categoria,
  ...
  public static ActivityVistaRicettaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageButton buttonShare = rootView.findViewById(id);
      if (buttonShare == null) {
        break missingId;
      }
      ...
      return new ActivityVistaRicettaBinding((ScrollView) rootView, Ingredienti, Quantit,
          UnitDimisura, button2, buttonShare, categoria, immagineRicettaVista, intolleranze,
          origine, photo, procedimentoVista, tableLayout, tableLayout2, tableLayout3, tableLayout4,
