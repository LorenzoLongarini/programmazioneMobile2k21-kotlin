...
public final class FragmentRicettaDelGiornoBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentRicettaDelGiornoBinding(@NonNull ScrollView rootView,
      @NonNull TextView Ingredienti, @NonNull TextView Quantit, @NonNull TextView UnitDimisura,
      ...
      @NonNull TextView procedimentoVista, @NonNull TableLayout tableLayout,
      @NonNull TableLayout tableLayout2, @NonNull TableLayout tableLayout3,
      @NonNull TableLayout tableLayout4, @NonNull TextView tempoCottura,
      @NonNull TextView tempoPreparazione, @NonNull TextView tempoTotale,
      ...
      @NonNull TextView textView36, @NonNull TextView textView41, @NonNull TextView textView43,
      @NonNull TextView vegano) {
  ...
  @NonNull
  public static FragmentRicettaDelGiornoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentRicettaDelGiornoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_ricetta_del_giorno, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentRicettaDelGiornoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRicettaDelGiornoBinding((ScrollView) rootView, Ingredienti, Quantit,
