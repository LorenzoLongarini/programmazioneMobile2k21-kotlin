...
public final class IspiramiBinding implements ViewBinding {
  ...
  private IspiramiBinding(@NonNull ScrollView rootView, @NonNull TextView Ingredienti,
      ...
      @NonNull Button randomButton, @NonNull TableLayout tableLayout,
  ...
  public static IspiramiBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new IspiramiBinding((ScrollView) rootView, Ingredienti, Quantit, UnitDimisura,
          categoria, immagineRicettaVista, intolleranze, origine, photo, procedimentoVista,
          randomButton, tableLayout, tableLayout2, tableLayout3, tableLayout4, tempoCottura,
